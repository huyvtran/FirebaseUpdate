  ...
  _renderButton(obj, i) {
    return (
      <RadioButton
        ...
        onPress={(value, label, index) => {
          this.props.onPress(value, label, index);
          this.setState({ is_active_index: index });
        }}
      />
    );
    ...
    return (
      <View style={this.props.buttonWrapStyle} >
        <TouchableOpacity
          ...
          testID={this.props.testID}
          style={radioStyle}
          onPress={() => { this.props.onPress(this.props.obj.value, this.props.obj.label, this.props.index); }
          }
        >
          {c}
        </TouchableOpacity>
  ...
  render() {
    return (
      <TouchableWithoutFeedback
        ...
        onPress={() => {
          if (!this.props.disabled) {
            this.props.onPress(this.props.obj.value, this.props.obj.label, this.props.index);
          }
        }
        }
      >
